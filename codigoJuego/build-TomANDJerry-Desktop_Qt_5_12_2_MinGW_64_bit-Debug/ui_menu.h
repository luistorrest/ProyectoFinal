...
public:
    ...
    void setupUi(QMainWindow *Menu)
    {
        ...
        label->setGeometry(QRect(60, 10, 1141, 551));
        label->setPixmap(QPixmap(QString::fromUtf8(":/ImagenesJuego/Otros/fondoMenu.png")));
        label->setScaledContents(false);
        label->setAlignment(Qt::AlignJustify|Qt::AlignVCenter);
        UnJugador = new QPushButton(centralwidget);
        UnJugador->setObjectName(QString::fromUtf8("UnJugador"));
        UnJugador->setGeometry(QRect(970, 180, 281, 70));
        QFont font;
        font.setFamily(QString::fromUtf8("Schadow BT"));
        ...
        Multijugador->setGeometry(QRect(980, 260, 281, 70));
        Multijugador->setFont(font);
        ...
        line->setGeometry(QRect(50, 0, 1281, 16));
        QPalette palette;
        ...
        line_2->setGeometry(QRect(1318, -1, 20, 571));
        QPalette palette1;
        ...
        line_3->setGeometry(QRect(50, 565, 1281, 16));
        QPalette palette2;
        ...
        line_4->setGeometry(QRect(38, 7, 20, 571));
        QPalette palette3;
        ...
        pushButton->setGeometry(QRect(990, 340, 291, 70));
        QFont font1;
        font1.setFamily(QString::fromUtf8("Schadow BT"));
        ...
        QFont font2;
        font2.setFamily(QString::fromUtf8("Schadow BT"));
        font2.setPointSize(12);
        font2.setBold(true);
        font2.setWeight(75);
        menuWar_Fly->setFont(font2);
